...
(function() {
  ...
  exports.Dispatch = Dispatch = (function(_super) {
    ...
    function Dispatch() {
      ...
      this._handlers = {};
      this._seqid = 1;
      this._debug_hook = null;
      Dispatch.__super__.constructor.apply(this, arguments);
    }

    Dispatch.prototype.set_debug_hook = function(h) {
    ...
    Dispatch.prototype.invoke = function(_arg, cb, out) {
      ...
      if (this._debug_hook) {
        ...
        this._debug_hook(debug_msg.msg());
      }
      this.send(msg);
      (function(__iced_k) {
        if ((cb != null) || !notify) {
          ...
          (function(__iced_k) {
            ...
            return __iced_k(_this._debug_hook ? (debug_msg.response(error, result), _this._debug_hook(debug_msg.msg())) : void 0);
          });
        } else {
          return __iced_k();
        }
    ...
    Dispatch.prototype._serve = function(_arg) {
      ...
      if (pair) {
        return pair[1].call(pair[0], param, response);
