...
(function() {
  ...
  exports.Logger = Logger = (function() {
    ...
    function Logger(_arg) {
      ...
      if (!this.prefix) this.prefix = "RPC";
    ...
    Logger.prototype.debug = function(m) {
      if (this.level <= L.DEBUG) return this._log(m, "D");
    };

    Logger.prototype.info = function(m) {
      if (this.level <= L.INFO) return this._log(m, "I");
    };

    Logger.prototype.warn = function(m) {
      if (this.level <= L.WARN) return this._log(m, "W");
    };

    Logger.prototype.error = function(m) {
      if (this.level <= L.ERROR) return this._log(m, "E");
    };

    Logger.prototype.fatal = function(m) {
      if (this.level <= L.FATAL) return this._log(m, "F");
    };

    Logger.prototype._log = function(m, l, ohook) {
      var parts;
      if (this.prefix != null) parts = [this.prefix];
      if (l) parts.push("[" + l + "]");
