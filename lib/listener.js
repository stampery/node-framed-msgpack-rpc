...
(function() {
  var List, Listener, Transport, iced, net, __iced_k, __iced_k_noop;
  ...
  exports.Listener = Listener = (function() {
    ...
    Listener.prototype._warn = function(err, hook) {
      var addr;
    ...
    Listener.prototype.listen_retry = function(delay, cb, log_hook) {
