...
(function() {
  ...
  exports.Listener = Listener = (function() {
    ...
    Listener.prototype.set_debugger = function(d, apply_to_children) {
      var _this = this;
      this._dbgr = d;
      if (apply_to_children) {
        return this.walk_children(function(c) {
          return c.set_debugger(d);
        });
      }
    };

    Listener.prototype.set_debug_flags = function(f, atc) {
      return this.set_debugger(dbg.make_debugger(f, this.log_obj, this.log_obj.debug), atc);
    };
