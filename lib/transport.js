...
(function() {
  ...
  exports.TcpTransport = TcpTransport = (function(_super) {
    ...
    function TcpTransport(_arg) {
      var tcp_stream;
      this.port = _arg.port, this.host = _arg.host, this.tcp_opts = _arg.tcp_opts, tcp_stream = _arg.tcp_stream, this.log_obj = _arg.log_obj, this.parent = _arg.parent, this.do_tcp_delay = _arg.do_tcp_delay, this.hooks = _arg.hooks;
