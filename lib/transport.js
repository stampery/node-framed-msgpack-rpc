...
(function() {
  var Dispatch, Lock, RobustTransport, TcpStreamWrapper, Timer, Transport, iced, log, net, __iced_k, __iced_k_noop,
  ...
  TcpStreamWrapper = (function() {
    ...
    TcpStreamWrapper.prototype.remote_address = function() {
      if (this._tcp_stream) {
  ...
  exports.Transport = Transport = (function(_super) {
    ...
    Transport.prototype.set_debug_hook = function(h) {
