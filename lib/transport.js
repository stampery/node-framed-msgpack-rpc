...
(function() {
  var Dispatch, Lock, RobustTransport, StreamWrapper, Timer, Transport, dbg, get_net_module, iced, log, __iced_k, __iced_k_noop,
  ...
  get_net_module = require('./net').get_net_module;
  ...
  exports.Transport = Transport = (function(_super) {
    ...
    Transport.prototype._post_connect = function(err, cb) {
      return cb(err);
    };
            ...
            if (!_this.is_connected()) {
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  _this._post_connect(err, __iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                        return err = arguments[0];
                      };
    ...
    Transport.prototype._connect_critical_section = function(cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      x = get_net_module().connect(this.net_opts);
  ...
  exports.RobustTransport = RobustTransport = (function(_super) {
            ...
            (function(__iced_k) {
              if (_this.is_connected()) {
                ...
                (function(__iced_k) {
                  ...
                  _this._post_connect(null, __iced_deferrals.defer({
                    lineno: 374
                  }));
                  __iced_deferrals._fulfill();
                })(__iced_k);
    ...
    RobustTransport.prototype._post_connect = function(err, cb) {
      this._flush_queue();
      return cb(err);
    };
