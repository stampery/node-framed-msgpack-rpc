...
function Client (transport, program) {
	...
	if (this._debugger) {
	    var self_debugger = this._debugger;
...
exports.createClient = function (hostname, port, cb, prog) {
    var tx = new Transport (hostname, port);
    var cli = new Client (tx, prog);
    tx.connect(cb);
    return cli;
};
...
var ServerConnection = function (server, tcpStream) {
    ...
    this.remoteToString = function() { return this._remote; }
...
var Server = function (newConnectionHook) {
	...
	var con = newConnectionHook (self, tcpStream);
	con.serve ();
    });
}
...
exports.createServer = function (arg) {
    var ret;
    if (typeof(arg) == "function") {
	ret = new Server (arg);
    } else if (typeof(arg) == "object") {
	ret = new Server(function(self, tcpStream) {
	    var scon = new ServerConnection(self, tcpStream);
	    scon.addPrograms(arg);
	    return scon;
	});
    }
    return ret;
